...
"use strict";
/* harmony export (immutable) */ __webpack_exports__["c"] = rand;
/* harmony export (immutable) */ __webpack_exports__["b"] = distance;
/* harmony export (immutable) */ __webpack_exports__["d"] = randPoint;
/* harmony export (immutable) */ __webpack_exports__["a"] = clamp;
/* harmony export (immutable) */ __webpack_exports__["f"] = wallRect;
function rand(lower, upper = null) {
  if (upper === null) {
    upper = lower;
    lower = 0;
  }
...
function randPoint(size, resolution) {
  return [rand(0, size) * resolution + 17, rand(0, size) * resolution + 17];
}
...
function wallRect(type, gridX, gridY) {
  if (type === "VERT") {
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__path_node__ = __webpack_require__(44);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_lodash_isEqual__ = __webpack_require__(45);
...
class PathFinder {
  ...
  unvisited(pos) {
    return this.visitedCells.find(el => __WEBPACK_IMPORTED_MODULE_1_lodash_isEqual___default()(el, pos)) === undefined;
  }

  newMoves(gridX, gridY) {
    let moves = [];
    //top
    if (gridY > 0 && !this.grid.horiz[gridX][gridY - 1] && this.unvisited([gridX, gridY - 1])) {
      moves.push([gridX, gridY - 1]);
    }
    //left
    if (gridX > 0 && !this.grid.vert[gridX - 1][gridY] && this.unvisited([gridX - 1, gridY])) {
      moves.push([gridX - 1, gridY]);
    }
    //bottom
    if (gridY < this.grid.vert.length - 1 && !this.grid.horiz[gridX][gridY] && this.unvisited([gridX, gridY + 1])) {
      moves.push([gridX, gridY + 1]);
    }
    //right
    if (gridX < this.grid.horiz.length - 1 && !this.grid.vert[gridX][gridY] && this.unvisited([gridX + 1, gridY])) {
      moves.push([gridX + 1, gridY]);
    }
  ...
  findPath(start, target) {
    ...
    const root = new __WEBPACK_IMPORTED_MODULE_0__path_node__["a" /* default */](null, start);
    let queue = [root];
    while (queue.length > 0) {
      ...
      for (let i = 0; i < newMoves.length; i++) {
        let move = newMoves[i];
        let newNode = new __WEBPACK_IMPORTED_MODULE_0__path_node__["a" /* default */](curNode, move);
        queue.push(newNode);
...
class Bullet {
  ...
  nextFrame() {
    ...
    let collision = this.detectCollision(newX, newY, this.size, "BULLET");
...
__WEBPACK_IMPORTED_MODULE_1_jquery___default()(() => {
  window.map = new __WEBPACK_IMPORTED_MODULE_0__map__["a" /* default */](7);
});
...
class Map {
  constructor(size) {
    ...
    this.map = __WEBPACK_IMPORTED_MODULE_1_jquery___default()("#map");
    this.tanks = [];
    this.bullets = new Set();
    this.AIBuilder = new __WEBPACK_IMPORTED_MODULE_6__ai_builder__["a" /* default */](this);
    this.resetMap();
    this.scores = [0, 0];
  ...
  addDot(x, y) {
    let dot = __WEBPACK_IMPORTED_MODULE_1_jquery___default()("<div class='dot'></dot");
    dot.css({ left: x + "px", top: y + "px" });
    __WEBPACK_IMPORTED_MODULE_1_jquery___default()("#map").append(dot);
  }

  createTank(type, dodge) {
    let id = this.tanks.length;
    this.map.append(`<div id='tank${id}' class='tank ${TANKCOLORS[id]}'></div>`);
    let startingPt = Object(__WEBPACK_IMPORTED_MODULE_0__util__["d" /* randPoint */])(this.size, this.resolution);
    let tank = new __WEBPACK_IMPORTED_MODULE_2__tank__["a" /* default */]({
      id,
      speed: 7,
      xPos: startingPt[0],
      yPos: startingPt[1],
      dir: Object(__WEBPACK_IMPORTED_MODULE_0__util__["c" /* rand */])(0, 360),
      map: this,
      type,
    ...
    if (type === "AI") {
      ...
      controller = new __WEBPACK_IMPORTED_MODULE_5__keyboard_controller2__["a" /* default */](tank.actions);
    }
  ...
  generateBullet(xPos, yPos, dir, tankId) {
    ...
    let bullet = new __WEBPACK_IMPORTED_MODULE_3__bullet__["a" /* default */]({
      xPos,
      yPos,
      dir,
      detectCollision: this.detectCollision.bind(this),
  ...
  mapGen(aX, aY, bX, bY) {
    ...
    //make vertical wall
    let bin = Object(__WEBPACK_IMPORTED_MODULE_0__util__["c" /* rand */])(0, 2);
    if (h === v && bin || v < h) {
      let wall = Object(__WEBPACK_IMPORTED_MODULE_0__util__["c" /* rand */])(aX, bX);
      let gap1 = Object(__WEBPACK_IMPORTED_MODULE_0__util__["c" /* rand */])(aY, bY * 1);
      let gap2 = Object(__WEBPACK_IMPORTED_MODULE_0__util__["c" /* rand */])(aY, bY * 2);
      for (let i = aY; i <= bY; i++) {
        if (i === gap1 || i === gap2) {
          continue;
        }
      ...
      let wall = Object(__WEBPACK_IMPORTED_MODULE_0__util__["c" /* rand */])(aY, bY);
      let gap = Object(__WEBPACK_IMPORTED_MODULE_0__util__["c" /* rand */])(aX, bX);
  ...
  updateScores(id) {
    ...
    this.scores[id]++;
    __WEBPACK_IMPORTED_MODULE_1_jquery___default()("#score" + id).html(this.scores[id]);
  }
  ...
  detectCollision(x, y, size, type) {
    ...
    let topLeft = [[gridX, gridY - 1], [gridX - 1, gridY], [gridX - 1, gridY - 1], [gridX - 1, gridY - 1]];

    let topRight = [[gridX, gridY - 1], [gridX, gridY], [gridX + 1, gridY - 1], [gridX, gridY - 1]];

    let bottomRight = [[gridX, gridY], [gridX, gridY], [gridX + 1, gridY], [gridX, gridY + 1]];

    let bottomLeft = [[gridX, gridY], [gridX - 1, gridY], [gridX - 1, gridY], [gridX - 1, gridY + 1]];

    let quadStr = __WEBPACK_IMPORTED_MODULE_0__util__["e" /* resolution */] / 2 > y % __WEBPACK_IMPORTED_MODULE_0__util__["e" /* resolution */] ? 'top' : 'bottom';
    quadStr += __WEBPACK_IMPORTED_MODULE_0__util__["e" /* resolution */] / 2 > x % __WEBPACK_IMPORTED_MODULE_0__util__["e" /* resolution */] ? 'Left' : 'Right';
    ...
    for (let i = 0; i < 4; i++) {
      ...
      try {
        if (walls[curX][curY]) {
          let rect = Object(__WEBPACK_IMPORTED_MODULE_0__util__["f" /* wallRect */])(wallType, curX, curY);
    ...
    if ((type === "BULLET" || type === "TEST_BULLET") && !collision) {
  ...
  checkRectCollision(x, y, size, rect) {
    ...
    let closestX = Object(__WEBPACK_IMPORTED_MODULE_0__util__["a" /* clamp */])(x, left, right);
    let closestY = Object(__WEBPACK_IMPORTED_MODULE_0__util__["a" /* clamp */])(y, top, bottom);
    let distX = x - closestX;
    let distY = y - closestY;
    // let distSq = distX ** 2 + distY ** 2;
    let dist = Object(__WEBPACK_IMPORTED_MODULE_0__util__["b" /* distance */])(x, y, closestX, closestY);
  ...
  checkTankCollision(x, y, size, type) {
    for (let i = 0; i < this.tanks.length; i++) {
      ...
      let dist = Object(__WEBPACK_IMPORTED_MODULE_0__util__["b" /* distance */])(x, y, tankPos[0], tankPos[1]);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__pathFinder_path_finder__ = __webpack_require__(22);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_jquery__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_jquery___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_jquery__);
...
class Tank {
  constructor({ id, speed, xPos, yPos, dir, detectCollision, generateBullet, map, type }) {
    ...
    this.ammo = 5;
    this.ref = __WEBPACK_IMPORTED_MODULE_1_jquery___default()(`#tank${this.id}`);
    this.detectCollision = detectCollision;
  ...
  handleShoot() {
    if (this.fireInterval === 0 && this.actions.shoot && this.ammo > 0) {
      ...
      __WEBPACK_IMPORTED_MODULE_1_jquery___default()(".dot").css({ top: turretY + "px", left: turretX + "px" });
...
/* harmony export (immutable) */ __webpack_exports__["a"] = PathNode;
...
var Symbol = __webpack_require__(16),
    Uint8Array = __webpack_require__(28),
    eq = __webpack_require__(4),
    equalArrays = __webpack_require__(27),
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_lodash_merge__ = __webpack_require__(35);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_lodash_merge___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_lodash_merge__);


class KeyboardController1 {
  constructor(actions) {
  ...
  handleKeyDown(e) {
    ...
    switch (key) {
      case 87:
        __WEBPACK_IMPORTED_MODULE_0_lodash_merge___default()(this.actions, { up: true, down: false });
        break;
      case 68:
        __WEBPACK_IMPORTED_MODULE_0_lodash_merge___default()(this.actions, { right: true });
        break;
      case 65:
        __WEBPACK_IMPORTED_MODULE_0_lodash_merge___default()(this.actions, { left: true });
        break;
      case 83:
        __WEBPACK_IMPORTED_MODULE_0_lodash_merge___default()(this.actions, { down: true, up: false });
        break;
      case 84:
        __WEBPACK_IMPORTED_MODULE_0_lodash_merge___default()(this.actions, { shoot: true });
        break;
    }
  }
  ...
  handleKeyUp(e) {
    ...
    switch (key) {
      case 87:
        __WEBPACK_IMPORTED_MODULE_0_lodash_merge___default()(this.actions, { up: false });
        break;
      case 68:
        __WEBPACK_IMPORTED_MODULE_0_lodash_merge___default()(this.actions, { right: false });
        break;
      case 65:
        __WEBPACK_IMPORTED_MODULE_0_lodash_merge___default()(this.actions, { left: false });
        break;
      case 83:
        __WEBPACK_IMPORTED_MODULE_0_lodash_merge___default()(this.actions, { down: false });
        break;
      case 84:
        __WEBPACK_IMPORTED_MODULE_0_lodash_merge___default()(this.actions, { shoot: false });
        break;
    }
  }
}
...
var Stack = __webpack_require__(23),
    ...
    baseMergeDeep = __webpack_require__(110),
    isObject = __webpack_require__(2),
...
var Uint8Array = __webpack_require__(28);
...
/* harmony default export */ __webpack_exports__["a"] = (KeyboardController2);
...
class AIController {
  constructor(tank, map, { fireInterval, bulletAwareness, targetAwareness }) {
    //adjustable traits
  ...
  tankCell(tank) {
    return [Math.floor(tank.xPos / __WEBPACK_IMPORTED_MODULE_4__util__["e" /* resolution */]), Math.floor(tank.yPos / __WEBPACK_IMPORTED_MODULE_4__util__["e" /* resolution */])];
  }

  cellToCoords(cell) {
    return cell.map(pt => pt * __WEBPACK_IMPORTED_MODULE_4__util__["e" /* resolution */] + __WEBPACK_IMPORTED_MODULE_4__util__["e" /* resolution */] / 2);
  }
  opTank() {
  ...
  setNewWayPoints(includeFirst) {
    const pf = new __WEBPACK_IMPORTED_MODULE_2__pathFinder_path_finder__["a" /* default */](this.grid);
    if (Object(__WEBPACK_IMPORTED_MODULE_0__util_js__["b" /* distance */])(...this.tank.center(), ...this.opTank().center()) > 100) {
      this.waypoints = pf.getWaypoints(this.tankCell(this.tank), this.tankCell(this.opTank()));
    } else {
      let randCell = [Object(__WEBPACK_IMPORTED_MODULE_0__util_js__["c" /* rand */])(0, this.map.size), Object(__WEBPACK_IMPORTED_MODULE_0__util_js__["c" /* rand */])(this.map.size)];
  ...
  handler() {
    __WEBPACK_IMPORTED_MODULE_1_lodash_merge___default()(this.actions, { shoot: false });
    // console.log(this.state);
    this.handleWayPoints();
    switch (this.state) {
      case "IDLE":
        this.checkForBullets() || this.checkForTarget() || this.nextWaypoint();
        break;
      case "AVOIDING":
  ...
  checkForBullets() {
    ...
    this.map.bullets.forEach(bullet => {
      ...
      if (Math.abs(bulletPos[0] - this.tank.center()[0]) < this.bulletAwareness && Math.abs(bulletPos[1] - this.tank.center()[1]) < this.bulletAwareness) {
        dangerousBullets.push(bullet);
      }
    });
    if (dangerousBullets.length > 0) {
      __WEBPACK_IMPORTED_MODULE_1_lodash_merge___default()(this.actions, { down: true });
      __WEBPACK_IMPORTED_MODULE_1_lodash_merge___default()(this.actions, { up: false });
      __WEBPACK_IMPORTED_MODULE_1_lodash_merge___default()(this.actions, { [this.rotDir]: false });
      this.state = "AVOIDING";
      return true;
    } else {
      if (this.state === "AVOIDING") {
        __WEBPACK_IMPORTED_MODULE_1_lodash_merge___default()(this.actions, { down: false });
  ...
  rotate() {
    ...
    __WEBPACK_IMPORTED_MODULE_1_lodash_merge___default()(this.actions, { [this.rotDir]: true });
    this.state = "ROTATING";
  ...
  forward() {
    __WEBPACK_IMPORTED_MODULE_1_lodash_merge___default()(this.actions, { up: true });
    this.executeForward();
    this.state = "MOVING";
  }

  executeForward() {
    let targetDistance = Object(__WEBPACK_IMPORTED_MODULE_0__util_js__["b" /* distance */])(this.tank.xPos + this.tank.size / 2, this.tank.yPos + this.tank.size / 2, this.targetX, this.targetY);
  ...
  handleFire(enemyDir) {
    if (Math.abs(enemyDir - this.tank.dir) <= 7) {
      __WEBPACK_IMPORTED_MODULE_1_lodash_merge___default()(this.actions, { shoot: true });
      this.lastShot = 0;
      this.state = "IDLE";
      __WEBPACK_IMPORTED_MODULE_1_lodash_merge___default()(this.actions, { [this.rotDir]: false });
  ...
  checkForTarget() {
    if (this.lastShot === this.fireInterval) {
      ...
      let bullet = new __WEBPACK_IMPORTED_MODULE_3__test_bullet__["a" /* default */]({
        xPos: this.tank.xPos,
        yPos: this.tank.yPos,
        dir: enemyDir,
...
/* harmony export (immutable) */ __webpack_exports__["a"] = AIController;
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__bullet__ = __webpack_require__(34);


class TestBullet extends __WEBPACK_IMPORTED_MODULE_0__bullet__["a" /* default */] {
  constructor(params) {
    super(params);
    this.hit = false;
    this.speed = 7;
  ...
  nextFrame() {
    this.life--;
    let collision = this.detectCollision(this.xPos, this.yPos, this.size, "TEST_BULLET");
    if (collision[0] === "VERT_COLLISION") {
      this.bounceX();
    }
