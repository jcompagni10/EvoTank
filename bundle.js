...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__tanks__ = __webpack_require__(28);
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  __WEBPACK_IMPORTED_MODULE_1_react_dom___default.a.render(__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_2__tanks__["a" /* default */], null), main);
});
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_react__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__tank__ = __webpack_require__(29);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__bullet__ = __webpack_require__(31);
...
class Tanks extends __WEBPACK_IMPORTED_MODULE_0_react___default.a.Component {
  constructor() {
    super();
    let tankState = { speed: 10,
      ...
      dir: 90,
      ammo: 6 };
    let tanks = [__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1__tank__["a" /* default */], _extends({ key: '1', id: '1', color: 'red' }, tankState, { generateBullet: this.generateBullet.bind(this) })), __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1__tank__["a" /* default */], _extends({ key: '2', id: '2', color: 'blue' }, tankState, { generateBullet: this.generateBullet.bind(this) }))];
  ...
  generateBullet(x_pos, y_pos, dir) {
    ...
    this.state.bullets.push(__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_2__bullet__["a" /* default */], _extends({}, props, { key: Math.floor(Math.random() * 1000000000).toString() })));
    this.forceUpdate();
  }
  render() {
...
/* harmony default export */ __webpack_exports__["a"] = (Tanks);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_react__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__keyboard_controller1__ = __webpack_require__(32);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__keyboard_controller2__ = __webpack_require__(33);




class Tank extends __WEBPACK_IMPORTED_MODULE_0_react___default.a.Component {
  constructor({ id, generateBullet, speed, x_pos, y_pos, dir, ammo }) {
    ...
    if (id === '1') {
      const controller = new __WEBPACK_IMPORTED_MODULE_1__keyboard_controller1__["a" /* default */](this.state.keysDown);
    } else {
      const controller = new __WEBPACK_IMPORTED_MODULE_2__keyboard_controller2__["a" /* default */](this.state.keysDown);
    }
  }
  css() {
    return {
  ...
  move() {
    ...
    if (actions.shoot && this.state.ammo > 0) {
      this.state.ammo--;
      this.props.generateBullet(this.state.x_pos, this.state.y_pos, this.state.dir, this.state.ammo);
    }
  }
  inBounds(x, y) {
  ...
  render() {
    return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('div', { className: "tank " + this.props.color,
...
class Bullet extends __WEBPACK_IMPORTED_MODULE_0_react___default.a.Component {
  ...
  render() {
    return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('div', { className: "bullet " + this.state.class, 'data-life': this.state.life, style: this.css() });
  }
}
...
/* harmony default export */ __webpack_exports__["a"] = (KeyboardController1);
